...
final class USAElectionCampaignView: UIView {
    ...
    private let secondLabel: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = R.font.rubikRegular(size: 18)
        label.text = "Соревновательность в партии"
        label.textColor = .black
        return label
    }()
    ...
    private let thirdLabel: UILabel = {
        ...
        label.text = "Участие действующего президента"
        label.textColor = .black
        return label
    }()
    ...
    private let seventhLabel: UILabel = {
        ...
        label.translatesAutoresizingMaskIntoConstraints = false
        label.font = R.font.rubikRegular(size: 18)
        label.text = "Изменения в политике"
        label.textColor = .black
        return label
    }()
    ...
    private func setConstraints() {
        ...
        [firstLabel, firstTextField, secondLabel, secondTextField, thirdLabel, thirdTextField, fourthLabel, fouthrTextField, fifthLabel, fifthTextField, sixthLabel, sixthTextField, seventhLabel, seventhTextField, eighthLabel, eighthTextField, ninthLabel, ninthTextField, tenthLabel, tenthTextField, eleventhLabel, eleventhTextField, twelfthLabel, twelfthTextField, thirteenthLabel, thirteenthTextField].forEach{
