...
public final class GradientView: UIView {
	...
	public var saturation: CGFloat = 1 {
		didSet {
			gradient = Gradient.colorSliderGradient(saturation: saturation, whiteInset: whiteInset, blackInset: blackInset, isMonochrome: false)
		}
	}
    ...
    required public init(orientation: Orientation, saturation: CGFloat, whiteInset: CGFloat, blackInset: CGFloat, isMonochrome: Bool) {
		self.orientation = orientation
		self.gradient = Gradient.colorSliderGradient(saturation: saturation, whiteInset: whiteInset, blackInset: blackInset, isMonochrome: isMonochrome)
...
public extension GradientView {
	...
	override func layoutSubviews() {
		...
		if automaticallyAdjustsCornerRadius {
			...
			let automaticCornerRadius = shortestSide / 3.0
...
fileprivate extension Gradient {
    static func colorSliderGradient(saturation: CGFloat, whiteInset: CGFloat, blackInset: CGFloat, isMonochrome: Bool) -> Gradient {
        ...
        let hues: [CGFloat] = values //[0.125, 0.132, 0.14, 0.147, 0.155, 0.162, 0.17, 0.178, 0.185, 0.193, 0.208]//values
        ...
        return Gradient(colors: colors, locations: locations, isMonochrome: isMonochrome)
	}
}
